...
"""
 'alfa-romeo', 'aston-martin', 'acura', 'audi', 'bentley','bmw', 'buick', 'cadillac', 'chevrolet',
 """
companies=[  'chrysler','dodge', 'ferrari',  'ford', 'honda',  'hyundai', 'infiniti', 'jaguar', 'jeep', 'kia',  'land-rover',
